...
const handler = require('../page-actions/handlers')
...
const display = () => {
    ...
    iconAddProject.addEventListener('click', handleAddProject)

    iconAddTodo.addEventListener('click', handleAddTodo)
    ...
    todosOrderedByTime.forEach(eachTodo => {
        ...
        iconEdit.addEventListener('click', event => {
            ...
            cancelBtn.addEventListener('click', () => {
                ...
                displayRelatedTodos(app.defaultProject())
            })
        })
...
const handleAddProject = () => {
    ...
    addBtn.addEventListener('click', (event) => {
        ...
        if (app.isTitleExist(title)) {
            warnings.addWarningBefore(addBtn.parentElement, 'Project name already exists!')
            return
        }
        if (title === '') {
            warnings.addWarningBefore(addBtn.parentElement, 'Project name should not be empty!')
            return
        }
    ...
    cancelBtn.addEventListener('click', handler.cancelAddProject)
}
...
const handleAddTodo = () => {
    ...
    cancelBtn.addEventListener('click', handler.cancelAddTodo)
}